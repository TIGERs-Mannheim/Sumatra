...
public enum ESupportBehavior implements IInstanceableEnum, IEvent
{
	...
	PENALTY_AREA_ATTACKER(new InstanceableClass<>(PenaltyAreaAttackerRepulsiveBehavior.class)),
	BREAKTHROUGH_DEFENSIVE(new InstanceableClass<>(BreakThroughDefenseRepulsiveBehavior.class)),
	...
	MOVE_VORONOI(new InstanceableClass<>(MoveOnVoronoiRepulsiveBehavior.class)),
