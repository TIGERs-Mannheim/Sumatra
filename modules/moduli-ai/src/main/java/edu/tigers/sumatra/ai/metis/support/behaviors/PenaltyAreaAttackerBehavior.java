...
public class PenaltyAreaAttackerBehavior extends ASupportBehavior
{
	...
	private void drawHelpLines(IVector2 destination, IVector2 myPos, IVector2 kickOrigin)
	{
		...
		{
			double startAngle = Vector2.fromPoints(center, intersectionsA.getFirst()).getAngle();
			double endAngle = Vector2.fromPoints(center, intersectionsB.getFirst()).getAngle();
