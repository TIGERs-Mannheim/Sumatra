...
public class Agent extends AAgent
{
	 ...
	 */
	public Agent(@SuppressWarnings("unused") final SubnodeConfiguration subnodeConfiguration)
	{
	}
	...
	public void changeMode(final EAiTeam aiTeam, final EAIControlState mode)
	{
		...
		} else
		{
			...
			aiManager.setMixedTeamEnabled(mode == EAIControlState.MIXED_TEAM_MODE);
		}
