...
public class MatchStats
{
	...
	public String toJSON()
	{
		...
		{
			jsonObject.put(entry.getKey(), entry.getValue().getTextualRepresenationOfGeneralStatistic());
			for (Map.Entry<BotID, String> e : entry.getValue().getTextualRepresentationOfBotStatistics().entrySet())
			{
