 ...
 */
public class LegacyDefensePenArea implements IDefensePenArea
{
	 ...
	 */
	public LegacyDefensePenArea(final double radius, final double frontLineLength)
	{
		this.radius = radius;
	...
	@Override
	public LegacyDefensePenArea withMargin(final double margin)
	{
		return new LegacyDefensePenArea(Math.max(0, radius + margin), frontLineLength);
	}
	...
	private boolean isPointInShapeOrBehind(final IVector2 point)
	{
	...
	private boolean isBehindPenaltyArea(final IVector2 point)
	{
