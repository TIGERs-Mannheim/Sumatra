...
public class AroundObstacleCalc
{
	...
	{
		var line = Lines.segmentFromPoints(getPos(), desiredDest);
		IVector2 lp = line.toLine().closestPointOnPath(obstacle);
		if (line.isPointOnPath(lp) && (line.distanceTo(obstacle) < (obstacleRadius + Geometry.getBotRadius())))
		{
