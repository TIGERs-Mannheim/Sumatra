...
{
	private static final Logger log = Logger.getLogger(OptimalBallInterception.class.getName());
	...
	public double objectiveFunction(final double t)
	{
	...
	private BangBangTrajectory2D getBotTrajectory(final IVector2 ballPos)
	{
		...
		return TrajectoryGenerator.generatePositionTrajectory(moveConstraints, bot.getPos(), bot.getVel(), botDest);
	}
