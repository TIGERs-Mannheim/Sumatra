...
public class BotSkillFastGlobalPosition extends AMoveBotSkill
{
	 ...
	 * @param mc
	 */
	public BotSkillFastGlobalPosition(final IVector2 xy, final double orientation, final IMoveConstraints mc)
	{
		this();
