...
package edu.dhbw.mannheim.tigers.sumatra.view.testplays;
...
import edu.dhbw.mannheim.tigers.sumatra.view.testplays.panels.ACommandDetailsPanel;
import edu.dhbw.mannheim.tigers.sumatra.view.testplays.panels.CommandPanel;
import edu.dhbw.mannheim.tigers.sumatra.view.testplays.panels.KickCommandPanel;
import edu.dhbw.mannheim.tigers.sumatra.view.testplays.panels.PassCommandPanel;
import edu.dhbw.mannheim.tigers.sumatra.view.testplays.panels.PathCommandPanel;
import edu.dhbw.mannheim.tigers.sumatra.view.testplays.panels.ReceiveCommandPanel;
import edu.dhbw.mannheim.tigers.sumatra.view.testplays.panels.RedirectCommandPanel;
import edu.dhbw.mannheim.tigers.sumatra.view.testplays.panels.SyncCommandPanel;
...
public class TestPlayPanel extends JPanel implements ISumatraView
{
	...
	class RoleListModel extends AbstractListModel implements ITestPlayDataObserver
	{
	...
	class CommandSelectionListener implements ListSelectionListener
	{
		...
		public void valueChanged(final ListSelectionEvent e)
		{
			...
			ACommand selectedCommand = (ACommand) commandList.getSelectedValue();
	...
	class RoleAddCommand implements ActionListener
	{
	...
	class RoleRemoveCommand implements ActionListener
	{
		...
		public void actionPerformed(final ActionEvent e)
		{
			...
			{
				TestPlayManager.getInstance().removeRole((CommandList) roleList.getSelectedValue());
			}
		}
	}
	...
	class CommandRemoveCommand implements ActionListener
	{
		...
		public void actionPerformed(final ActionEvent e)
		{
			...
			TestPlayManager.getInstance().getCommandQueue().get(roleList.getSelectedIndex())
					.remove((ACommand) commandList.getSelectedValue());
			commandListModel.update();
		}
	}
	...
	private class CommandUpCommand implements ActionListener
	{
		...
		public void actionPerformed(final ActionEvent actionEvent)
		{
			...
			ACommand command = (ACommand) commandList.getSelectedValue();
