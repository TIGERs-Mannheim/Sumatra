...
/**
 * Panel for path commands.
 */
public class PathCommandPanel extends ACommandDetailsPanel
{
	private static final Logger log = LogManager.getLogger(PathCommandPanel.class.getName());
	...
	class PointListModel extends AbstractListModel<Point>
	{
		...
		@Override
		public Point getElementAt(final int index)
		{
