 ...
 * *********************************************************
 */
package edu.dhbw.mannheim.tigers.sumatra.view.logfile;
...
public class LogfilePanel extends JPanel implements ISumatraView
{
	...
	private static final Logger log = Logger
			.getLogger(LogfilePanel.class.getName());
	...
	private final JButton btnNextFew;
	private final JButton btnPrevFew;
	private final JButton btnPrevMuch;
	private final JButton btnNextMuch;
	private final JButton btnLoadLogfile;
	private final JButton btnMergeTool;
	private final JButton btnSkipToDirectIndirect;
	...
	public LogfilePanel()
	{
		...
		btnMergeTool = new JButton("Merge Tool");
		...
		add(btnPause);
		add(position, "growx, pushx");
		add(lblTime, "wrap");
		add(btnLoadLogfile, "aligny top");
		...
		ctrl.add(sliderSpeed);
		ctrl.add(labelSpeed);
		ctrl.add(btnSkipToDirectIndirect);
		ctrl.add(btnMergeTool, "aligny top");
		
		add(ctrl, "pushy, aligny top, alignx center");
	}
