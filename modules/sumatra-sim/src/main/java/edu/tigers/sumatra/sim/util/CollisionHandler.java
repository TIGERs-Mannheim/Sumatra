...
public class CollisionHandler
{
	...
	private void adjustBotPosition(final SumatraBotPair tempPair)
	{
		...
		tempBotList.get(0).setPos(Vector3.from2d(botPositionOne, tempBotList.get(0).getPos().getXYZVector().z()));
		tempBotList.get(1).setPos(Vector3.from2d(botPositionTwo, tempBotList.get(1).getPos().getXYZVector().z()));
	}
