...
import edu.tigers.sumatra.gui.ai.aicenter.view.AICenterPanel;
import edu.tigers.sumatra.gui.ai.aicenter.view.IRoleControlPanelObserver;
import edu.tigers.sumatra.gui.ai.aicenter.view.RoleControlPanel;
 ...
 */
public class AICenterPresenter implements ISumatraViewPresenter
{
	@Getter
	...
	public void onModuliStopped()
	{
		...
		SwingUtilities.invokeLater(() -> viewPanel.setActive(false));
	}
	...
	public void onModuliStarted()
	{
		...
		SwingUtilities.invokeLater(() -> viewPanel.setActive(true));
	...
	private void updateAiControlStateForTeam(EAiTeam team)
	{
		if (agent != null)
		{
			...
			SwingUtilities.invokeLater(() -> viewPanel.setAiControlStateForAi(controlState, team));
		}
	}
