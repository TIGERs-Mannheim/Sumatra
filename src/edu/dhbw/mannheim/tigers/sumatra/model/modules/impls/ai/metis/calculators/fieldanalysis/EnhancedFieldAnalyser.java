...
public class EnhancedFieldAnalyser
{
	 ...
	 * "Finde den Gipfel des Mt. Everest mit Ged�chtnisverlust in dichtem
	 * Nebel�
	 * @param situation
	 * @param bestRectangle
	 * @return
	...
	private AIRectangle searchWithHillClimbing(ESituation situation, AIRectangle bestRectangle)
	{
		...
		if (situation == ESituation.FREE) // Search for minimum opponent presence
		{
			do
			{
