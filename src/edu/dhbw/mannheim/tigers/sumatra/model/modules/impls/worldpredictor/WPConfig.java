...
import edu.dhbw.mannheim.tigers.sumatra.model.modules.impls.worldpredictor.oextkal.TrackingManager;
...
public class WPConfig
{
	...
	public static final double		FILTER_CONVERT_MperS_TO_INTERNAL_V				= 1e-6
																												* FILTER_CONVERT_MM_TO_INTERNAL_UNIT
																												/ FILTER_CONVERT_NS_TO_INTERNAL_TIME;
	public static final double		FILTER_CONVERT_MperSS_TO_INTERNAL_A				= 1e-15
																												* FILTER_CONVERT_MM_TO_INTERNAL_UNIT
	...
	public static long				FILTER_TIME_OFFSET;																																						// =
																																																							// System.nanoTime();
																																																							
	public static final long		S_IN_NS													= 1000000000l;
	
	/** [internalTime] How often the {@link TrackingManager} should check the data in the {@link PredictionContext} */
	...
	public static final double		MIN_CAMFRAME_DELAY_TIME								= 0.001
																												* S_IN_NS
																												* FILTER_CONVERT_NS_TO_INTERNAL_TIME;															// 1ms
	...
	public static final float		NOISE_S													= 10.0f;																										// maximal
																																																							// noise
																																																							// (mm)
	public static final float		NOISE_R													= 0.09f;																										// maximal
																																																							// noise
																																																							// (rad)
	// :::<<<
	...
	public static boolean	CORRECT_BALL_DATA								       		= true;
}
