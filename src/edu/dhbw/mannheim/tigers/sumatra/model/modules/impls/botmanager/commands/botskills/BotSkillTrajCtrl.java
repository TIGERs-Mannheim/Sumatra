 ...
 * @author AndreR
 */
public class BotSkillTrajCtrl extends ABotSkill
{
	...
	/** */
	public BotSkillTrajCtrl()
	{
		super(EBotSkill.TRAJ_CTRL);
	}
	 ...
	 * @param orientation
	 */
	public BotSkillTrajCtrl(final IVector2 xy, final float orientation)
	{
		super(EBotSkill.TRAJ_CTRL);
