...
public class RcmAction
{
	...
	public enum EActionType
	{
		...
		/** ESkillname */
		SKILL(ESkillName.class, ESkillName.KICK, ESkillName.INTERCEPTION, ESkillName.REDIRECT),
		/** ERcmEvent */
	...
	public static List<RcmAction> getDefaultActions()
	{
		...
		actions.add(new RcmAction(ESkillName.KICK, EActionType.SKILL));
		actions.add(new RcmAction(ESkillName.INTERCEPTION, EActionType.SKILL));
		return actions;
	}
	...
	public static RcmAction fromJSON(final JSONObject jsonAction)
	{
		...
		switch (actionType)
		{
			...
			case SIMPLE:
				...
				break;
			case SKILL:
				actionEnum = ESkillName.valueOf(strActionEnum);
				break;
			default:
