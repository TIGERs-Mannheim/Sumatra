...
public abstract class AVisibleCon extends ACondition
{
	 ...
	 * @param botID
	 */
	public void addToIgnore(BotID botID)
	{
	 ...
	 * @param botID
	 */
	public void removeFromIgnore(BotID botID)
	{
	...
	{
		return GeoMath.p2pVisibility(worldFrame, start, end, raySize, new ArrayList<BotID>(ignoreIds));
	}
	 ...
	 */
	public final void setRaySize(float raySize)
	{
