...
public class FreekickArea implements I2DShape
{
	...
	private final Linef				freekickAreaFrontLine;
	
	private final Circlef			freekickCirclePos;
	private final Circlef			freekickCircleNeg;
	private final Vector2f			freekickCirclePosCentre;
	private final Vector2f			freekickCircleNegCentre;
	
	private final Rectanglef		freekickRectangle;
	...
	public FreekickArea(ETeam owner, Configuration config)
	{
		...
		if (owner == ETeam.TIGERS)
		{
			...
			freekickAreaFrontLine = new Linef(new Vector2(goalCenter.x() + radiusOfFreekickArea, goalCenter.y()),
					new Vector2(0, 1));
			freekickRectangle = new Rectanglef(new Vector2(goalCenter.x() + radiusOfFreekickArea, goalCenter.y()
		...
		freekickCirclePos = new Circlef(freekickCirclePosCentre, radiusOfFreekickArea);
		
		freekickCircleNegCentre = new Vector2f(goalCenter.x(), goalCenter.y() - lengthOfFreekickAreaFrontLineHalf);
		freekickCircleNeg = new Circlef(freekickCircleNegCentre, radiusOfFreekickArea);
	}
	 ...
	 */
	public final Linef getFreekickAreaFrontLine()
	{
	 ...
	 */
	public final Circlef getFreekickCirclePos()
	{
	 ...
	 */
	public final Circlef getFreekickCircleNeg()
	{
	 ...
	 */
	public final Rectanglef getFreekickRectangle()
	{
