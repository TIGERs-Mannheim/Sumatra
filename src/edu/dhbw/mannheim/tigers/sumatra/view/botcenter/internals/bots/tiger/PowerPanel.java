...
public class PowerPanel extends JPanel
{
	...
	private Chart2D				iVccChart			= new Chart2D();
	private Chart2D				i5VChart				= new Chart2D();
	
	private static final int	DATA_SIZE			= 400;
	
	private ITrace2D				iVccTrace			= new Trace2DLtd(DATA_SIZE);
	private ITrace2D				i5VTrace				= new Trace2DLtd(DATA_SIZE);
	private ITrace2D				i3V3Trace			= new Trace2DLtd(DATA_SIZE);
	...
	public PowerPanel()
	{
		...
		JPanel currentPanel = new JPanel(new MigLayout("fill, wrap 3", "[50]10[100,fill]10[20]"));
		...
		String rowConstraints = "[50]10[100,fill]10[20]";
		String columnConstraints = "[20,fill][20,fill][20,fill][20,fill][20,fill]";
		JPanel voltagePanel = new JPanel(new MigLayout("fill, wrap 3", rowConstraints, columnConstraints));
		...
		i5VChart.setBackground(this.getBackground());
		...
		iVccChart.setBackground(this.getBackground());
