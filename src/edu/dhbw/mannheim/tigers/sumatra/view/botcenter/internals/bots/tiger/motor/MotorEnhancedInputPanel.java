...
public class MotorEnhancedInputPanel extends JPanel
{
	...
	private static final float MAX = 6.0f;	// [m/s]
...
//		g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING,RenderingHints.VALUE_ANTIALIAS_ON);
		...
		g2.drawOval((int)(SIZE/2 + SIZE/MAX*target.x - 4), (int)(SIZE/2 + SIZE/MAX*-target.y - 4), 8, 8);

		g2.setColor(Color.RED);
		g2.fillOval((int)(SIZE/2 + SIZE/MAX*latest.x - 3), (int)(SIZE/2 + SIZE/MAX*-latest.y - 3), 6, 6);
		
		g2.setColor(Color.BLACK);
		g2.drawRect((int)(SIZE/2 + SIZE/MAX*wpLatest.x - 3), (int)(SIZE/2 + SIZE/MAX*-wpLatest.y - 3), 6, 6);
	...
	private void notifyNewVelocity(Vector2 xy)
	{
		synchronized(observers)
		{
			for (IMotorEnhancedInputPanel observer : observers)
			{
