...
/**
 * Class for testing several functions provided by {@link AVector2}, {@link Vector2}, {@link AVector3} and
 * {@link Vector3}
 * 
 * @author Malte
 * 
...
public class VectorTest
{
	...
	public void testTurnNew()
	{
		...
		output = input.turnNew(AIMath.PI / 2);
		...
		output = input.turnNew(4 * AIMath.PI);
	...
	{
		Vector2 vec1 = new Vector2(1, 0);
		vec1.turnTo(AIMath.PI);
		assertEquals(vec1.x, -1, ACCURACY);
		assertEquals(vec1.y, 0, ACCURACY);
		
		vec1 = new Vector2(1, 0);
		vec1.turnTo(AIMath.PI * (-0.5f));
		assertEquals(vec1.x, 0, ACCURACY);
		assertEquals(vec1.y, -1, ACCURACY);
	...
	{
		IVector2 vec1 = new Vector2(1, 0);
		IVector2 vec2 = new Vector2(2, 4);
		IVector2 vec3 = new Vector2(0, 0);
