...
public class PersistenceTestHelper
{
	 ...
	 * @param frames
	 */
	public static void checkFrames(List<IRecordFrame> frames)
	{
	 ...
	 * @param validator
	 */
	public static void checkFrames(List<IRecordFrame> frames, Validator validator)
	{
		...
		System.out.println("Validation of frames took " + (System.nanoTime() - startTime));
	}
	
	
	private static void printConstraintViolation(ConstraintViolation cv)
	{
