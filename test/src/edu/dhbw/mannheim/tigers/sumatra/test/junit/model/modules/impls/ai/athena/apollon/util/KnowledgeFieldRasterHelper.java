...
/**
 * Test class for KnowledgeFieldRaster
 * 
 * @author Nicolai Ommer <nicolai.ommer@gmail.com>
 * 
 */
public class KnowledgeFieldRasterHelper extends AKnowledgeFieldHelper
{
	// --------------------------------------------------------------------------
	...
	{
		IBotIDMap<TrackedBot> foeBots = new BotIDMap<TrackedBot>();
		IBotIDMap<TrackedTigerBot> tigerBots = new BotIDMap<TrackedTigerBot>();
