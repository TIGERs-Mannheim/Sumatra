 ...
 * *********************************************************
 */
package edu.dhbw.mannheim.tigers.sumatra.test.junit.model.data.shapes.ellipse;
...
public class EllipseTest implements I2DShapeTest
{
	...
	private List<Ellipse> getTurnedEllipses()
	{
		...
		final List<Ellipse> ells = new ArrayList<Ellipse>(10);
		Ellipse tmpEll;
		tmpEll = new Ellipse(new Vector2(0, 0), 70, 100, (float) Math.PI);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(0, 0), 70, 100, (float) Math.PI / 2);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(0, 0), 70, 100, (float) Math.PI / 4);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(0, 0), 70, 100, (float) Math.PI * 2);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(100, 100), 70, 100, (float) Math.PI);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(-100, -100), 70, 100, (float) Math.PI);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(100, -100), 70, 100, (float) Math.PI);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(100, -100), 70, 100, (float) Math.PI / 2);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(100, -100), 70, 100, (float) Math.PI / 4);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(100, -100), 70, 100, (float) Math.PI * 2);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(-100, 100), 70, 100, (float) Math.PI);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(0, 0), 9, 10, (float) Math.PI);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(0, 0), 13, 1000, (float) Math.PI);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(0, 0), 2000, 4000, (float) Math.PI);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(0, 0), 3999, 4000, (float) Math.PI);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(0, 0), 1000, 1000, (float) Math.PI);
		ells.add(tmpEll);
		
		tmpEll = new Ellipse(new Vector2(0, 0), 100, 70, (float) Math.PI);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(100, 100), 100, 70, (float) Math.PI);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(-100, -100), 100, 70, (float) Math.PI);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(-100, -100), 100, 70, (float) Math.PI / 2);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(-100, -100), 100, 70, (float) Math.PI / 4);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(-100, -100), 100, 70, (float) Math.PI * 2);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(100, -100), 100, 70, (float) Math.PI);
		...
		tmpEll = new Ellipse(new Vector2(-100, 100), 100, 70, (float) Math.PI);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(0, 0), 10, 9, (float) Math.PI);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(0, 0), 1000, 13, (float) Math.PI);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(0, 0), 4000, 2000, (float) Math.PI);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(0, 0), 4000, 3999, (float) Math.PI);
		ells.add(tmpEll);
		tmpEll = new Ellipse(new Vector2(0, 0), 1000, 1000, (float) Math.PI);
		ells.add(tmpEll);
		return ells;
	...
	public void testGetFocusFromCenter()
	{
		for (Ellipse ell : getAllEllipses())
		{
			...
			float distCF = GeoMath.distancePP(ell.getCenter().addNew(focusFromCenter), ell.getCenter());
			
			// final float x = (ell.getRadiusX() < ell.getRadiusY() ? ell.getRadiusX() : 0);
			// final float y = (ell.getRadiusX() < ell.getRadiusY() ? 0 : ell.getRadiusY());
	...
	public void testConstructor()
	{
		...
		Assert.assertTrue(center.equals(ell.getCenter(), (float) ASSERT_EQUALS_DELTA));
	}
	...
	/**
	 * Test intersecting methods {@link Ellipse#getIntersectingPoints(ILine)}
	...
	public void testIntersecting()
	{
		for (Ellipse ell : getAllEllipses())
		{
			...
			lines.put(tmpLine, 2);
			float smallerRadius = Math.min(ell.getRadiusX(), ell.getRadiusY());
			...
			for (Map.Entry<ILine, Integer> entry : lines.entrySet())
			{
				...
				List<IVector2> points = ell.getIntersectingPoints(line);
				...
				{
					float dist = GeoMath.distancePP(ell.getCenter(), p);
	...
	public void testNearestPointOutside()
	{
		for (Ellipse ell : getAllEllipses())
		{
			IVector2 p1 = ell.getCenter().addNew(new Vector2(0, ell.getRadiusY() / 2).turn(ell.getTurnAngle()));
	...
	/**
	 * Tests {@link Ellipse#stepOnCurve(IVector2, float)}
	 */
	@Test
	public void testStepOnCurve()
	{
		for (Ellipse ell : getAllEllipses())
		{
			Map<Float, Float> cfs = new HashMap<Float, Float>(2);
			cfs.put(ell.getCircumference(), 0f);
			cfs.put(-ell.getCircumference(), 0f);
			cfs.put(ell.getCircumference() / 2, (ell.getRadiusY() * 2));
			cfs.put(-ell.getCircumference() / 2, (ell.getRadiusY() * 2));
			for (Map.Entry<Float, Float> entry : cfs.entrySet())
			{
				float circumference = entry.getKey();
				...
				float dist = GeoMath.distancePP(start, end);
				// we are not that accurate
				final float tol = 2f + entry.getValue();
	...
	public void testGetCircumference()
	{
		...
		Ellipse ell4 = new Ellipse(new Vector2(42, -42), 2200, 1800, (float) Math.PI / 2);
