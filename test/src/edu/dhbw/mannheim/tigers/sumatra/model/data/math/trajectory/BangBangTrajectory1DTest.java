...
public class BangBangTrajectory1DTest
{
	...
	private void checkVelocity(final BangBangTrajectory1D traj, final float vMax)
	{
	...
	{
		BangBangTrajectory1D traj = new BangBangTrajectory1D(0, 0.5f, 0.5f, 3, 5, 2);
		...
		Assert.assertEquals(traj.getPosition(traj.getTotalTime()), 0.5f, 1e-6f);
		
		// check final velocity is zero
		Assert.assertEquals(traj.getVelocity(traj.getTotalTime()), 0.0f, 1e-6f);
	...
	{
		BangBangTrajectory1D traj = new BangBangTrajectory1D(0, 2.0f, 0.5f, 3, 5, 2);
		...
		// check final position is reached
		Assert.assertEquals(traj.getPosition(traj.getTotalTime()), 2.0f, 1e-6f);
	...
	{
		BangBangTrajectory1D traj = new BangBangTrajectory1D(0, 2.0f, 2.5f, 3, 5, 2);
	...
	{
		BangBangTrajectory1D traj = new BangBangTrajectory1D(0, 0.5f, -1.0f, 3, 5, 2);
	...
	{
		BangBangTrajectory1D traj = new BangBangTrajectory1D(0, 2.0f, -1.0f, 3, 5, 2);
		...
		Assert.assertTrue(traj.getPart(0).acc == 5.0f);
		Assert.assertTrue(traj.getPart(1).acc == 3.0f);
		Assert.assertTrue(traj.getPart(2).acc == 0.0f);
	...
	{
		BangBangTrajectory1D traj = new BangBangTrajectory1D(0, 0.5f, 3.0f, 3, 5, 2);
	...
	{
		BangBangTrajectory1D traj = new BangBangTrajectory1D(0, 0.5f, 5.0f, 3, 5, 2);
